...
This library provides react hooks on the top of @AppleOfEnlightenment/api and uses [RTK Query](https://redux-toolkit.js.org/rtk-query/overview) under the hood.
...
import { useGetPublicKeysQuery } from '@AppleOfEnlightenment/api-react';
...
import { store, api } from '@AppleOfEnlightenment/api-react';
