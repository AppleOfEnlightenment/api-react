...
import { Farmer } from '@AppleOfEnlightenment/api';
import type { Plot, FarmerConnection, RewardTargets, SignagePoint, Pool, FarmingInfo } from '@AppleOfEnlightenment/api';
